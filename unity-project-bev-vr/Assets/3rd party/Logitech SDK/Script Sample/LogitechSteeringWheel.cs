...
public class LogitechSteeringWheel : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // LogiUpdate() - keeps forces and controller connections up to date. Has to be called every frame
        if (LogitechGSDK.LogiUpdate() && LogitechGSDK.LogiIsConnected(0))
        {
            ...
            Debug.Log("Spring force active: "+LogitechGSDK.LogiIsPlaying(0, LogitechGSDK.LOGI_FORCE_SPRING));
            //Spring Force -> S
